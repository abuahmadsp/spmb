...
async function initializeDatabase() {
  try {
    // Tentukan lokasi database SQLite
    ...
    // Membuat tabel-tabel sesuai dengan desain database
    await db.exec(`
      ...
      CREATE INDEX IF NOT EXISTS idx_applicants_campus_id ON applicants(campus_id);
      CREATE INDEX IF NOT EXISTS idx_applicants_school_id ON applicants(school_id);
      CREATE INDEX IF NOT EXISTS idx_student_data_applicant_id ON student_data(applicant_id);
      CREATE INDEX IF NOT EXISTS idx_quota_campus_id ON quota(campus_id);
      CREATE INDEX IF NOT EXISTS idx_quota_school_id ON quota(school_id);
      CREATE INDEX IF NOT EXISTS idx_school_admins_user_id ON school_admins(user_id);
      CREATE INDEX IF NOT EXISTS idx_school_admins_campus_id ON school_admins(campus_id);
      CREATE INDEX IF NOT EXISTS idx_application_status_history_applicant_id ON application_status_history(applicant_id);
    ...
    // Menambahkan data awal jika tabel kosong
